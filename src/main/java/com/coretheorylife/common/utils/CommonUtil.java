...
public class CommonUtil {
	...
	public static String generateOID() {
		return TicketdashiUUID.generateOID();
	}
	...
	public static String base64Encorder(String value){
		byte[] bases = Base64.encodeBase64(value.getBytes());
		try {
			return new String(bases,"utf-8");
	...
	public static String base64Decoder(String value){
		byte[] bases = Base64.decodeBase64(value);
		try {
			return new String(bases,"utf-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
	...
	public static String phoneRegex = "1\\d{10}";
...
//			"dd.M.yyyy hh:mm:ss a", "dd.MMM.yyyy", "dd-MMM-yyyy", "yyyy-MM-dd"};
	 ...
	 * @return
	 */
	public static final String TELEPHONE_REG = "/0\\d{2,3}-\\d{7,8}/";
